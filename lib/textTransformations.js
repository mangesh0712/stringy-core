...
// Truncates a string to a specified number of words and appends a custom ending.
function truncateWords(string, wordCount, ending = '...') {
	// Input: 'This is a long string that needs to be truncated', 4
	// Output: 'This is a long...'
...
// Grouped exports
export { shuffle, removeDuplicates, shorten, wordWrap, truncateWords };
